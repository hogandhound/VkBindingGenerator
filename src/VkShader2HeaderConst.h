...
const char* createShaderModule= R"(static VkShaderModule createShaderModule(VkDevice device, const char* code, size_t codeSize) {
...
const char* shader_mid = R"z(
    ...
    viewport.x = 0.0f;
    viewport.y = 0.0f;
    viewport.width = (float)target->swapChainExtent.width;
    viewport.height = (float)target->swapChainExtent.height;
